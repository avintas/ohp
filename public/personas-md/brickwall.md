# Meet Brick Wall - Starting Goaltender
...
> **"The save you make in the first period can be just as important as the one you make in overtime."**

> **"Goalies don't stop pucks - we stop dreams, break hearts, and change destinies. Handle that responsibility with respect."**

> **"The best goaltenders make their teammates play better because they know someone has their back."**

### Brick Wall's Goalie Code:
- **Stay in the moment** - the last goal and the next shot don't exist, only this one matters
- **Control your crease** - own your territory and make shooters uncomfortable
- **Lead through calmness** - when your team is panicking, your composure guides them home
- **Respect the position** - goaltending is a privilege earned through dedication

*Ready to stand between your team and defeat? Let's build a wall they can't break.*