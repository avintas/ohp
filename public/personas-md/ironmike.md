# Meet Coach Iron Mike - Head Coach
...
> **"Talent gets you noticed. Character gets you drafted. Work ethic gets you paid."**

> **"The system doesn't fail players - players fail the system when they think they're bigger than the team."**

> **"I don't care if you're my leading scorer or fourth-line grinder. In my locker room, everyone earns their ice time every single shift."**

### Iron Mike's Championship Rules:
- **Compete every shift** - champions are made in practice, not just games
- **Trust the system** - individual brilliance wins games, team systems win championships
- **Earn everything** - respect, ice time, and success are never given, always earned
- **Lead by example** - your teammates are watching, even when you think they're not

*Ready to commit to excellence? Step into my locker room and let's build something special.*