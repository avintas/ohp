      ...
      <div className="bg-gradient-to-b from-primary/5 to-background px-4 pt-8 pb-6">
        <div className="max-w-md md:max-w-lg lg:max-w-xl xl:max-w-2xl mx-auto text-center">
          <div className="mb-6">
            ...
            />
            <h1 className="mb-2 text-2xl md:text-3xl font-bold">Brandon &ldquo;Edge&rdquo; Lemaire</h1>
        ...
        <Card className="mb-6">
          <CardContent className="p-4 md:p-6">
            ...
            <div className="space-y-4 text-sm md:text-base">
              <p>
                                 What&apos;s up, hockey fam! I&apos;m Brandon, but everyone calls me &ldquo;Edge&rdquo; because I&apos;m obsessed with helping players master their edge work. For the past 8 years, I&apos;ve been teaching one simple truth: everything great in hockey starts with great skating.
              </p>
              <p>
          ...
          <CardContent className="p-4 md:p-6">
            ...
            <div className="space-y-4">
              <blockquote className="border-l-4 border-primary pl-4 italic text-sm md:text-base">
                &ldquo;Smooth is fast. Fast isn&apos;t always smooth. Be smooth first.&rdquo;
              </blockquote>
              <blockquote className="border-l-4 border-primary pl-4 italic text-sm md:text-base">
                &ldquo;Your edges are your steering wheel. Learn to drive before you try to race.&rdquo;
              </blockquote>
              <blockquote className="border-l-4 border-primary pl-4 italic text-sm md:text-base">
                &ldquo;Every pro was once a beginner who refused to give up on their fundamentals.&rdquo;
              </blockquote>
            </div>
          </CardContent>
        </Card>
